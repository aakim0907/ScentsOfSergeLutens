...
var svg = d3.select("div.body-2").append("svg").attr("width", 1000).attr("height", 700);
...
var links = svg.selectAll("link").data(data.links).enter().append("line").attr("class", "link").attr("x1", function (l) {
...
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open '/home/aakim0907/ScentsOfSergeLutens/lib/data.json'");
